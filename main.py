...
def apply(intrests, driver):
    ...
    for x in range(1,41):  
        url="https://internshala.com/internships/backend-development,front-end-development,java,javascript-development,node-js-development,python-django-internship/stipend-10000/page-2/"

        if applied == True:
            driver.get(url)
            time.sleep(3)

        no_thanks=exists_xpath('//*[@id="no_thanks"]')
        if  no_thanks[0]:
            no_thanks.click()
        ...
        try:
            ...
            if to_apply:
                ...
                try:
                    ...
                    try:
                        driver.find_element(By.XPATH, '//*[@id="availability_heading"]')
                        while True:
                            print("Please Click On your avalidblity")
                            submitted=input("Did you do it?(y/n)")
                            if submitted=="y":
                                break
                    except:
                        pass
                    ...
                    while True:
                            print("Please answer the assment question")
                            submitted=input("Did you do it?(y/n)")
                            if submitted=="y":
                                break
